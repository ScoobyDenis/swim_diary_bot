...
LEXICON_COMMANDS_RU: dict[str, str] = {
    ...
    '/season1': '🏅 лидеры первого сезона', #'/leaderboard': '🏆таблица лидеров за все время', 
...
ADMIN_MENU = f"/cancel - удалить из расписания\n" \
             ...
             f"/admins_registr - запись админом в расписание\n" \
             f"/get_users_info -получить id, имена и фамилии\n" \
             f"/get_parents_info - родители\n" \
             f"/get_parents_kids_info - дети родителя\n" \
             f"/cancel_admin - отмена тренировки\n" \
             f"/check_time_for_admin - смотреть рекорды\n" \
